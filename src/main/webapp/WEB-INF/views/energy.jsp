...
<script type="text/javascript">
    function deleteEntry(id)
    {
        if (confirm('Are you sure you want to delete this item?')) {
            $.ajax({url: '/fitJournal/api/journal/' + id, type: 'DELETE', success: function() {
                location.reload();
            }});
        }
    }
    ...
    {
        $.ajax({url: '/fitJournal/api/journal/' + id, success: function(entry){
    ...
    {
        var type = 'POST';
        var url = '/fitJournal/api/journal';
        var data = {
            id: entryId.value,
    ...
    function getJournalPeriod()
    {
        ...
        $.ajax({url: '/fitJournal/api/journalPeriod', data: data, success: function(period){
    ...
    {
        $.ajax({url: '/fitJournal/api/journalPeriod', success: function(period){
            addAdditionalProps(period);
